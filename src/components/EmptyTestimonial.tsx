    ...
    <div className="w-full flex flex-col items-center justify-center py-24 px-4">
      <div className="mb-20 text-center">
        <h2 className="text-3xl font-medium tracking-tight text-foreground md:text-4xl lg:text-5xl">
          Wall of{" "}
          <motion.span
            className="relative cursor-default inline-flex items-center gap-2 px-4 py-1 rounded-2xl bg-primary/5 border border-primary/10 text-primary hover:bg-primary/10 hover:border-primary/20 transition-all duration-300"
          >
            Love
          </motion.span>
        </h2>
      ...
      <div
        ...
        className="relative w-[235px] h-[160px] cursor-pointer flex justify-center items-end overflow-visible mb-12"
      >
        <div className="absolute inset-x-0 bottom-0 h-44 flex justify-center items-end overflow-visible select-none">
          {[
            {
              initial: { rotate: -15, y: -20, x: -30 },
              open: {
                rotate: -28,
                y: -60,
                x: -75,
      ...
      <div className="text-center space-y-4">
        <p className="text-xl text-foreground tracking-tight">
          Belum ada testimonial publik. <br />
          <span className="text-muted-foreground text-lg">
            Jadilah yang pertama memberi testimoni.
          </span>
        </p>
...
const Page = () => (
  <div className="w-full h-full bg-gradient-to-b from-white to-[#F5F5F7] rounded-xl border border-neutral-200 p-4 dark:from-neutral-900 dark:to-neutral-950 dark:border-neutral-800">
    <div className="flex flex-col gap-2">
      <div className="w-full h-1.5 bg-neutral-100 dark:bg-neutral-850 rounded-full" />
      {Array.from({ length: 8 }).map((_, i) => (
        <div key={i} className="flex gap-2">
          <div className="flex-1 h-1.5 bg-neutral-100 dark:bg-neutral-850 rounded-full" />
          <div className="flex-1 h-1.5 bg-neutral-100 dark:bg-neutral-850 rounded-full" />
        </div>
      ))}
    </div>
